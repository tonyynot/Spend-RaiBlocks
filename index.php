...
<body>
	<div class= "topBar">
	  <span class= "button"><a class="buttonLink" href="map.html">Map</a></span>
	  <h1 class = "title">Spend RaiBlocks</h1>
	</div>
	...
	<img class ="infoImage" src="logo.png" alt="Raiblocks" width="80" height="80">
